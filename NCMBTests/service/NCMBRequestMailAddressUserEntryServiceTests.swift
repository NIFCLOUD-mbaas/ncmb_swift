...
/// NCMBRequestMailAddressUserEntryService のテストクラスです。
final class NCMBRequestMailAddressUserEntryServiceTests: NCMBTestCase {
    ...
    func test_send_request() {
        ...
        let sut = NCMBRequestMailAddressUserEntryService()
        sut.send(object: object, callback: {result in
            XCTAssertEqual(executor.requests.count, 1)
            XCTAssertEqual(executor.requests[0].apiType, NCMBApiType.requestMailAddressUserEntry)
            ...
            XCTAssertEqual(try! executor.requests[0].getURL(), URL(string: "https://mbaas.api.nifcloud.com/2013-09-01/requestMailAddressUserEntry"))
    ...
    func test_createPostRequest() {
        ...
        XCTAssertEqual(request.apiType, NCMBApiType.requestMailAddressUserEntry)
        ...
        XCTAssertEqual(try! request.getURL(), URL(string: "https://mbaas.api.nifcloud.com/2013-09-01/requestMailAddressUserEntry"))
